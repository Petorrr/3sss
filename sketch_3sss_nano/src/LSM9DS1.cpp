/*
  Modified by PvdV for the purpose of 3SSS project
...
int LSM9DS1Class::begin()
{
  ...
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG3_G, 0x80);  // Enable Gyro low power mode
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG1_G, 0x38);  // 14.9 Hz, 2000 dps, N.A BW
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG4_G, 0x20);  // Enable only Z axis gyro
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_ORIENT_CFG_G, 0x08); // Reverse Z axis gyro for 3SSS
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG6_XL, 0x70); // 119 Hz, 4G

  writeRegister(LSM9DS1_ADDRESS_M, LSM9DS1_CTRL_REG1_M, 0x90); // Temperature compensation enable, low-power performance, 10 Hz
...
void LSM9DS1Class::powerOnGyro() {
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG1_G, 0x38);  // 14.9 Hz, 2000 dps, N.A BW
}

void LSM9DS1Class::powerOffGyro() {
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG1_G, 0x18);  // Power down, 2000 dps, N.A BW
}
...
void LSM9DS1Class::end()
{
  ...
  // Disable both i2c interfaces to stop current draw
  //writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG9, 0x04);
  //writeRegister(LSM9DS1_ADDRESS_M, LSM9DS1_CTRL_REG3_M, 0x83);
